...
namespace GameZone.Migrations
{
    ...
    public partial class InitialCreating : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "Id", "GameId", "Icon", "Name" },
                values: new object[,]
                {
                    { 1, null, "bi bi-playstation", "Playstation" },
                    { 2, null, "bi bi-xbox", "xbox" },
                    { 3, null, "bi bi-nintendo-switch", "Ninetndo" },
                    { 4, null, "bi bi-pc-display", "PC" }
                });
